          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-[#ffe500] text-[#2874f0] text-[10px] font-bold rounded-sm uppercase">Seller</span>
              </div>
              {storeName && <div className="text-[11px] text-white/85">{storeName}</div>}
            </div>
          </div>
        </div>
        <button
